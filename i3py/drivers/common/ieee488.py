...
from i3py.core import subsystem
from i3py.core.actions import Action, RegisterAction
from i3py.core.features import Bool, Register, Unicode
...
class IEEEStatusReporting(VisaMessageDriver):
    ...
    * `*SRE?` - See IEC 60488-2:2004(E) section 10.35
    ...
    @RegisterAction(('operation complete', 'request control', 'query error',
                     'device dependent error', 'execution error',
                     'command error', 'user request', 'power on',))
