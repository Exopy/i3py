...
# XXX add a special class for rack like instruments to allow to register new
#     channels for cards.
# XXX use a metaclass subclass to run finalize_cls after the end of class
#     creation to setup all device dependent stuff (such as use of scpi and
#     case sensitive matching)
class Device(BaseComponentMixin):
...
class Devices(object):
    ...
    def add_device(self, resource_name, device, parameters):
